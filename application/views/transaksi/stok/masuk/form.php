<div class="box box-primary">
	...
	<form role="form" action="<?=base_url('stok/proses/masuk/') ?>" method="post" enctype="multipart/form-data">
		<div class="box-body row">
	      ...
	      <div class="form-group row">
			...
			<div class="col-sm-6">
	          ...
	          <input type="number" class="form-control" id="jumlah" name="jumlah" value="0" autofocus>
      ...
      <a href="<?=base_url('stok/masuk') ?>" class="btn btn-sm btn-flat btn-default pull-right"><i class="fa fa-times"></i> Batal</a>
