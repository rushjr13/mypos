<div class="box box-primary">
  <div class="box-header">
    ...
    <a href="<?=base_url('stok/masuk/tambah') ?>" class="btn btn-sm btn-primary btn-flat pull-right" title="Tambah"><i class="fa fa-plus"></i></a>
  </div>
  <!-- /.box-header -->
  <div class="box-body table-responsive">
    <table id="table2" class="table table-bordered table-striped table-hover" width="100%">
      ...
      <tbody>
        ...
        <?php }else{ ?>
          <tr>
            <td class="text-center" style="vertical-align: middle;" colspan="8">Tidak ada data yang tersedia!</td>
          </tr>
        <?php } ?>
      </tbody>
    </table>
...
<script type="text/javascript">
  $(document).on("click", "#hapusstok", function(){
    ...
    $("#modalHapus #ket").html("Anda yakin ingin menghapus stok masuk "+nama_item+" sejumlah "+jumlah+" ?");
    $("#modalHapus #formhapusmodal").attr("action","<?=base_url() ?>stok/stok_masuk_hapus/"+id_stok);
  })
</script>